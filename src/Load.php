...
final class Load {
	...
	private static function requireAll(): void {
		...
		$files = array(
			...
			__DIR__ . '/Abilities/FindMediaAbility.php',
			__DIR__ . '/Abilities/GetMediaAbility.php',
			__DIR__ . '/Abilities/ImportMediaAbility.php',
			__DIR__ . '/Abilities/UpdateMediaAbility.php',
			__DIR__ . '/Abilities/SetFeaturedImageAbility.php',
			__DIR__ . '/Abilities/InsertMediaAbility.php',
			__DIR__ . '/Repositories/PostRepository.php',
			__DIR__ . '/Repositories/TermRepository.php',
			__DIR__ . '/Repositories/MediaRepository.php',
			__DIR__ . '/Services/PostService.php',
			__DIR__ . '/Services/TermService.php',
			__DIR__ . '/Services/MediaService.php',
